...
function openNewEmployee() {
  openModal('Novo Colaborador', `
    <div class="form-row">
      ...
      <div class="form-group"><label>E-mail</label><input type="email" id="ne-email" placeholder="maria@empresa.com"></div>
    </div>
    <div class="form-row">
...
<div class="page-body">
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
    <div class="card">
      <div class="card-header"><i class="fa-solid fa-users-cog" style="color:var(--accent)"></i>Usuários do sistema</div>
      <div class="card-body">
        <button class="btn-primary" style="margin-bottom:16px" onclick="openNewUser()"><i class="fa-solid fa-user-plus"></i> Novo Usuário</button>
        ${users.map(u => `
          <div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--border)">
            ${avatarHtml(u.name, 34)}
            <div style="flex:1">
              <div style="font-size:13px;font-weight:500">${u.name}</div>
              <div style="font-size:11.5px;color:var(--text-3)">${u.email}</div>
            </div>
            <span class="badge ${u.role === 'admin' ? 'badge-purple' : 'badge-neutral'}">${u.role}</span>
    ...
    <div class="card">
      ...
      <div class="card-body" id="audit-body" style="max-height:400px;overflow-y:auto">
...
function openNewUser() {
  openModal('Novo Usuário', `
    <div class="form-row">
      ...
      <div class="form-group"><label>E-mail *</label><input type="email" id="nu-email" placeholder="email@empresa.com"></div>
    </div>
    <div class="form-row">
      <div class="form-group"><label>Senha *</label><input type="password" id="nu-pass" placeholder="Mínimo 6 caracteres"></div>
      <div class="form-group"><label>Perfil de Acesso</label><select id="nu-role">
